var planeObject = {
	...
	funcUpdateData	: function(data){
			...
			this.flight_orig	= data.flight_orig;
			this.flight_dest	= data.flight_dest;
			this.dep_time = data.dep_time;
			this.arr_time = data.arr_time;
			this.sched_dep = data.sched_dep;
			this.sched_arr = data.sched_arr;
